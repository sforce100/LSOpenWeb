...
declare module '@theme/SubNavbar' {
  const SubNavbar: () => JSX.Element;
  export default SubNavbar;
}


declare module '@theme/SubNavbarItem' {
  ...
  const SubNavbarItem: (props: Props) => JSX.Element;
...
declare module '@theme/LsToggle' {
  ...
  const LsToggle: (props: Props) => JSX.Element;

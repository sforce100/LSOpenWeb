...
- T5:tensor(int64)
  ...
  ![](../Training_Framework/files/gru_int.png)
...
- T5:tensor(int64)
  ...
  ![](../Training_Framework/files/gru_int_with_batch_length.png)
...
- T5:tensor(int64)
  ...
  ![](../Training_Framework/files/gru_int_with_batch_length_with_state.png)
...
- T1:tensor(float)
  ...
  ![](../Training_Framework/files/bmm_int.png)
